...
`0.3.0` is the current release. The `0.2.0-rc.1` manifest that preceded 0.2.0 was prepared and verified locally but never tagged or published; that candidate number was not consumed on the registry.
